...
class OvermindContractTests(unittest.TestCase):
    ...
    def test_overmind_migrations_run_from_tagged_ghcr_image(self) -> None:
        ...
        self.assertIn('"Host=" ~ overmind_postgres_bootstrap.container_name', migration_tasks)
        self.assertIn('";Password=" ~ overmind_postgres_bootstrap.admin_password', migration_tasks)
        self.assertNotIn('"postgresql://"', migration_tasks)
